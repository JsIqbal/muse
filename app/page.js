      ...
      <div className="curvey-top  flex flex-col gap-y-16 justify-center items-center w-screen h-auto flex-grow bg-[#F2F6F9] pt-32 pb-20 px-10">
        ...
        <div className="container flex-grow h-auto rounded-lg shadow-xl p-10 bg-white">
          ...
          <p className="text-gray-700">
            Welcome to our software product selling website! We offer a diverse
            range of cutting-edge software solutions designed to enhance your
            development and automation experiences.
          </p>
          <p className="text-gray-700 mt-2">Discover our featured products:</p>
          <div className="border rounded-lg p-4 mt-4">
            <h3 className="text-lg font-semibold">
              Muse: Middleware Universal Scripting idE
            </h3>
            <p className="text-gray-700 mt-2">
              Muse empowers you to automate WebSphere, WebLogic, JBoss,
              Glassfish, and Tomcat Middleware Estates over JMX using Python /
              Jython. With its user-friendly Eclipse-based Jython Development
              IDE, you can streamline your workflow and simplify server
              management.
            </p>
            <p className="text-gray-700 mt-2">
              Explore its features including Infrastructure-as-Code, Active
              Auditing Framework, and preset profiles for Server Compliance,
              making Pega and Informatica deployment a breeze.
            </p>
          </div>
          <div className="border rounded-lg p-4 mt-4">
            <h3 className="text-lg font-semibold">
            ...
            <p className="text-gray-700 mt-2">
              JET Pack offers essential tools for Java developers, encompassing
              OpenSource JDKs from Java 13 to 19. It includes Visual VM,
              JConsole, and MissionControl, providing powerful diagnostic
              capabilities to profile and optimize your code.
            </p>
            <p className="text-gray-700 mt-2">
              Simplify heap dumps, CPU and memory profiling, and diagnose
              memory-related issues effortlessly.
            </p>
          </div>
          <p className="text-gray-700 mt-4">
            Choose innovation and efficiency with our software products that
            redefine the way you develop, automate, and optimize your projects.
          </p>
        </div>
      </div>
        ...
        <div className="flex lg:flex-row flex-col justify-center items-center py-10 px-6 md:px-10 lg:px-[7%] xl:px-[10%] 2xl:px-[20%] flex-grow">
          <div className="lg:w-[50%] w-full flex flex-col justify-center items-start gap-y-8">
            <div className="flex flex-col gap-y-4">
              ...
              <p className="text-lg">
                Automate Middleware Management with Python/Jython. Target
                WebSphere, WebLogic, JBoss, Glassfish, and Tomcat over JMX and
                Linux SSH.
              </p>
              ...
              <div className="mt-8 space-y-6">
                <div className="text-[1rem] text-gray-700">
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    <p className="ml-5">
                      Manage Linux, WebSphere, WebLogic, JBoss, Glassfish,
                      Tomcat through JMX and Linux SSH without agents.
                    </p>
                    <p className="flex items-start">
                      <svg
                        className="flex-shrink-0 h-4 w-4 text-green-500"
                    ...
                    <p className="ml-5">
                      Access GIT Repository, apply SSL Configuration in clicks.
                      Performance Tune Pega (JBoss), Upgrade Vendor Apps, Build
                      WebLogic Domains quickly.
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:w-[50%] w-full flex flex-col justify-center items-start gap-y-8">
            <div className="flex flex-col gap-y-4">
              ...
              <p className="text-lg">
                ...
                identify bottlenecks, and optimize performance. Experience Java
                at its best.
              </p>
                ...
                <div className="text-[1rem] text-gray-700">
                  ...
                  <div className="mt-2 space-y-2">
                    <div className="flex items-start">
                      ...
                      <p className="ml-1">
                        OpenSource Java JDK Support: JETPack integrates with
                        Java JDKs 13-19, empowering developers to leverage
                    ...
                    <div className="flex items-start">
                      ...
                      <p className="ml-1">
                        Efficient Diagnostics: Tools like Visual VM, JConsole,
                        and MissionControl offer real-time insights into memory
                        usage, CPU performance, and smarter decision-making.
                      </p>
                    </div>
