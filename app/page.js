        ...
        <div className="container mx-10 flex-grow h-auto rounded-lg shadow-xl p-10 flex flex-col lg:flex-row gap-y-5 bg-white">
          <div className="flex flex-col w-[50%]">
            ...
            <p>
              ...
              Recusandae quos, reprehenderit iusto iste cum consequatur nesciunt
      ...
      <div className="w-screen  bg-white">
        <div className="flex py-10 px-6 md:px-10 lg:px-[7%] xl:px-[10%] 2xl:px-[20%] flex-grow">
          <div className="w-[50%] flex flex-col justify-center items-start gap-y-8">
            ...
            <p>
              Paragraph about the product ig and more Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Recusandae quos, reprehenderit iusto
              iste cum consequatur nesciunt alias numquam magnam labore.!!
              product ig and more Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Recusandae quos, reprehenderit iusto iste cum
