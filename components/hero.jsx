    ...
    <div className="mt-32 mb-16 flex md:flex-row flex-col gap-x-16 gap-y-4 w-full md:justify-between justify-start items-center">
      <div className="flex flex-col gap-6 md:w-[45%] w-full h-full justify-start">
        ...
        <h2 className="text-3xl lg:text-4xl text-slate-900 font-semibold">
          ...
          <span className={cn("text-blue-600 ", montsserrat.className)}>
            Nubinet
          </span>
        </h2>
        <p className="text-muted-foreground">
          Embark on a journey of innovation and efficiency with our cutting-edge
          software applications tailored to enhance every step of your software
          development process.
        </p>
        <Card className="shadow-sm hover:none space-y-0 w-">
          ...
          <CardContent className="flex gap-x-4">
            <h1 className="text-2xl font-semibold">{totalDownloads()}</h1>
