...
const Hero = () => {
  return (
    <div className="my-20 flex p-4 gap-10 w-full justify-between items-center">
      <div className="flex flex-col gap-6 w-[50%] h-full">
        <p className="text-sky-400">One platform blah blah.</p>
        <h2 className="text-2xl lg:text-3xl text-slate-900 font-semibold">
      ...
      <div className="relative w-[50%] h-full text-center align-middle">BIG POSTER IMAGE</div>
    </div>
  );
};
