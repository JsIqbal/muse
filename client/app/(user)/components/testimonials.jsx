    ...
    const testimonials = () => {
        return [
            ...
            },
            {
                name: "Jane Smith",
                role: "Developer",
                review: "As a developer, I'm always looking for tools that can boost my productivity. These software products have exceeded my expectations. The Middleware Universal Scripting idE is a masterpiece!",
            },
            {
                name: "Sam Johnson",
                role: "Student",
